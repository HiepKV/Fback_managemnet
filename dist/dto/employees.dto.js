...
let EmployeeDto = class EmployeeDto {
};
...
], EmployeeDto.prototype, "is_active", void 0);
exports.EmployeeDto = EmployeeDto = __decorate([
    (0, class_transformer_1.Exclude)()
], EmployeeDto);
function toEmployeeDto(employee) {
    return (0, class_transformer_1.plainToInstance)(EmployeeDto, employee, { strategy: 'excludeAll' });
}
